 ...
 */
/**
 * class itop_BusinessProcess
 *
 * @package Lib
 * @subpackage itop
 */
class itop_BusinessProcess extends itop_FunctionalCI {

	/**
	 * ********************* Creation de l'objet ********************
	 */
	/**
	 * Instancie un objet de type itop_BusinessProcess. @codeCoverageIgnore
	 ...
	 * @return itop_BusinessProcess
	 */
	static function &creer_itop_BusinessProcess(&$liste_option, &$itop_webservice_rest, $sort_en_erreur = false, $entete = __CLASS__) {
		abstract_log::onDebug_standard ( __METHOD__, 1 );
		$objet = new itop_BusinessProcess ( $sort_en_erreur, $entete );
	...
	static public function help() {
		...
		$help [__CLASS__] ["text"] [] .= "itop_BusinessProcess :";
