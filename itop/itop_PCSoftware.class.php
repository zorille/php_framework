...
class itop_PCSoftware extends itop_FunctionalCIi {
	 ...
	 */
	/**
	 * Instancie un objet de type itop_PCSoftware. @codeCoverageIgnore
	 ...
	 * @return itop_PCSoftware
	 */
	static function &creer_itop_PCSoftware(&$liste_option, &$itop_webservice_rest, $sort_en_erreur = false, $entete = __CLASS__) {
		abstract_log::onDebug_standard ( __METHOD__, 1 );
		$objet = new itop_PCSoftware ( $sort_en_erreur, $entete );
	...
	static public function help() {
		...
		$help [__CLASS__] ["text"] [] .= "itop_PCSoftware :";
