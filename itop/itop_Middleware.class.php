 ...
 */
/**
 * class itop_Middleware
 *
 * @package Lib
 * @subpackage itop
 */
class itop_Middleware extends itop_FunctionalCI {
	/**
	 * var privee
	 *
	 * @access private
	 ...
	 */
	/**
	 * Instancie un objet de type itop_Middleware. @codeCoverageIgnore
	 ...
	 */
	static function &creer_itop_Middleware(&$liste_option, &$itop_webservice_rest, $sort_en_erreur = false, $entete = __CLASS__) {
		abstract_log::onDebug_standard ( __METHOD__, 1 );
		$objet = new itop_Middleware ( $sort_en_erreur, $entete );
	...
	public function retrouve_Middleware($name, $server_name) {
	...
	public function gestion_Middleware($name, $org_name, $status, $business_criticity, $server_name, $software_friendlyname, $path, $move2production) {
	...
	static public function help() {
		...
		$help [__CLASS__] ["text"] [] .= "itop_Middleware :";
