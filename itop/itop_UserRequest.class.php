 ...
 */
/**
 * class itop_UserRequest
 *
 * @package Lib
 * @subpackage itop
 */
class itop_UserRequest extends itop_ci {
	/**
	 * var privee
	 *
	 * @access private
	 ...
	 */
	static function &creer_itop_UserRequest(&$liste_option, &$itop_webservice_rest, $sort_en_erreur = false, $entete = __CLASS__) {
		abstract_log::onDebug_standard ( __METHOD__, 1 );
		$objet = new itop_UserRequest ( $sort_en_erreur, $entete );
	...
	static public function help() {
		...
		$help [__CLASS__] ["text"] [] .= "itop_UserRequest :";
