 ...
 * @subpackage itop
 */
class itop_OSFamily extends itop_ci {

	/**
	 * ********************* Creation de l'objet ********************
	 */
	/**
	 * Instancie un objet de type itop_OSFamily. @codeCoverageIgnore
	 ...
	 */
	static function &creer_itop_OSFamily(&$liste_option, &$itop_webservice_rest, $sort_en_erreur = false, $entete = __CLASS__) {
		abstract_log::onDebug_standard ( __METHOD__, 1 );
		$objet = new itop_OSFamily ( $sort_en_erreur, $entete );
	...
	static public function help() {
		...
		$help [__CLASS__] ["text"] [] .= "itop_OSFamily :";
