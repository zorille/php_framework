 ...
 */
/**
 * class itop_PhysicalInterface
 *
 * @package Lib
 * @subpackage itop
 */
class itop_PhysicalInterface extends itop_ci {
	 ...
	 */
	static function &creer_itop_PhysicalInterface(&$liste_option, &$itop_webservice_rest, $sort_en_erreur = false, $entete = __CLASS__) {
		abstract_log::onDebug_standard ( __METHOD__, 1 );
		$objet = new itop_PhysicalInterface ( $sort_en_erreur, $entete );
	...
	static public function help() {
		...
		$help [__CLASS__] ["text"] [] .= "itop_PhysicalInterface :";
