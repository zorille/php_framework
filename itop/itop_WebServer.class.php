 ...
 */
/**
 * class itop_WebServer
 *
 * @package Lib
 * @subpackage itop
 */
class itop_WebServer extends itop_FunctionalCI {
	/**
	 * var privee
	 *
	 * @access private
	 ...
	 */
	/**
	 * Instancie un objet de type itop_WebServer. @codeCoverageIgnore
	 ...
	 */
	static function &creer_itop_WebServer(&$liste_option, &$itop_webservice_rest, $sort_en_erreur = false, $entete = __CLASS__) {
		abstract_log::onDebug_standard ( __METHOD__, 1 );
		$objet = new itop_WebServer ( $sort_en_erreur, $entete );
	...
	static public function help() {
		...
		$help [__CLASS__] ["text"] [] .= "itop_WebServer :";
