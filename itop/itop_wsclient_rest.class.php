...
/**
 * class itop_wsclient_rest<br>
 * Renvoi des information via un webservice.
 * @package Lib
 * @subpackage itop
 */
class itop_wsclient_rest extends wsclient {
	/**
	 * var privee
	 * @access private
	 * @var itop_datas
	 ...
	 */
	/**
	 * Instancie un objet de type itop_wsclient_rest. @codeCoverageIgnore
	 ...
	 */
	static function &creer_itop_wsclient_rest(&$liste_option, &$itop_datas, $sort_en_erreur = false, $entete = __CLASS__) {
		abstract_log::onDebug_standard ( __METHOD__, 1 );
		$objet = new itop_wsclient_rest ( $sort_en_erreur, $entete );
	...
	static public function help() {
		...
		$help = array_merge ( $help, itop_datas::help () );
