 ...
 */
/**
 * class itop_OtherSoftware
 *
 * @package Lib
 * @subpackage itop
 */
class itop_OtherSoftware extends itop_FunctionalCI {
	/**
	 * var privee
	 *
	 * @access private
	 ...
	 */
	/**
	 * Instancie un objet de type itop_OtherSoftware. @codeCoverageIgnore
	 ...
	 * @return itop_OtherSoftware
	 */
	static function &creer_itop_OtherSoftware(&$liste_option, &$itop_webservice_rest, $sort_en_erreur = false, $entete = __CLASS__) {
		abstract_log::onDebug_standard ( __METHOD__, 1 );
		$objet = new itop_OtherSoftware ( $sort_en_erreur, $entete );
	...
	public function &_initialise($liste_class) {
		...
		return $this ->setFormat ( 'OtherSoftware' ) 
	...
	public function retrouve_OtherSoftware($name, $server_name) {
	...
	public function gestion_OtherSoftware($name, $org_name, $status, $business_criticity, $server_name, $software_friendlyname, $path, $move2production) {
	...
	static public function help() {
		...
		$help [__CLASS__] ["text"] [] .= "itop_OtherSoftware :";
