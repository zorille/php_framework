...
/**
 * class solarwinds_wsclient_rest<br> Renvoi des information via un webservice.
 * @package Lib
...
class solarwinds_wsclient_rest extends wsclient {
	 ...
	 */
	static function &creer_solarwinds_wsclient_rest(
			&$liste_option,
			&$solarwinds_datas,
	 ...
	 * @codeCoverageIgnore
	 */
	public function &setObjetSolarwindsDatas(
			&$solarwinds_datas) {
