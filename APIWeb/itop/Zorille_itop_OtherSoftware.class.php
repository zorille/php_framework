...
class OtherSoftware extends FunctionalCI {
	 ...
	 */
	static function &creer_OtherSoftware(
			&$liste_option,
			&$webservice_rest,
	...
	public function retrouve_OtherSoftware(
			$name,
			$server_name) {
	 ...
	 */
	public function prepare_params_OtherSoftware(
			$parametres) {
	 ...
	 * @return OtherSoftware
	 */
	public function creer_oql_OtherSoftware(
			$fields = array ()) {
		$filtre = array ();
	 ...
	 * @return DBServer
	 */
	public function gestion_OtherSoftware(
			$parametres) {
		$this->onDebug ( __METHOD__, 1 );
		$params = $this->prepare_params_OtherSoftware ( $parametres );
		$this->onDebug ( $params, 1 );
		return $this->valide_mandatory_fields ()
			->creer_oql_OtherSoftware ( $parametres )
