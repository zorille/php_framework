...
class OtherSoftware extends FunctionalCI {
	 ...
	 */
	/**
	 * Instancie un objet de type OtherSoftware. @codeCoverageIgnore
	 ...
	 */
	static function &creer_OtherSoftware(&$liste_option, &$webservice_rest, $sort_en_erreur = false, $entete = __CLASS__) {
		Core\abstract_log::onDebug_standard ( __METHOD__, 1 );
		$objet = new OtherSoftware ( $sort_en_erreur, $entete );
	...
	static public function help() {
		...
		$help [__CLASS__] ["text"] [] .= "OtherSoftware :";
