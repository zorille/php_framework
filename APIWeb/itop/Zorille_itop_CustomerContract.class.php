...
class CustomerContract extends ci {
	...
	static function &creer_CustomerContract(
		...
		string        $entete = __CLASS__): CustomerContract
	{
	 ...
	 * @return CustomerContract
	 */
	public function &champ_obligatoire_standard(): CustomerContract
	{
	...
	public function retrouve_CustomerContract(
			$name,
			$org_name): ci|bool|CustomerContract
	{
	...
	public function creer_oql_CustomerContract(
		array $fields = array ()): CustomerContract
	{
		$filtre = array ();
	 ...
	 * @return Organization|null
	 */
	public function &getObjetItopProvider(): ?Organization
	{
