...
class WebApplication extends FunctionalCI {
	 ...
	 */
	static function &creer_WebApplication(&$liste_option, &$webservice_rest, $sort_en_erreur = false, $entete = __CLASS__) {
	 ...
	 * @codeCoverageIgnore
	 */
	public function &setObjetItopWebServer(&$WebServer) {
