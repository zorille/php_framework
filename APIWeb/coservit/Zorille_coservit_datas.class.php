...
class datas extends Core\serveur_datas {
	...
	public function retrouve_param(): static {
		...
		return $this->setServeurData ( $donnee_coservit );
	}

	/**
	 * Valide la presence de la definition d'un coservit nomme : $nom
	 *
	 * @param string $nom
	...
	static public function help(): array|string {
		...
		$help [__CLASS__] ["text"] [] .= "coservit Datas :";
		$help [__CLASS__] ["text"] [] .= "\t--coservit_machines_serveur {Donnees du/des serveur/s} Donnees contenus dans le fichier de configuration";
