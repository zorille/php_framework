...
class datas extends Core\serveur_datas {
	...
	public function retrouve_param(): datas
	{
		...
		$donnee_enedis = $this->_valideOption ( array (
				"enedis_machines",
				"serveur" 
		) );
		
		return $this->setServeurData ( $donnee_enedis );
	}

	/**
	 * Valide la presence de la definition d'un enedis nomme : $nom
	 *
	 * @param string $nom
	...
	static public function help(): array|string {
		...
		$help [__CLASS__] ["text"] [] .= "\t--enedis_machines_serveur {Donnees du/des serveur/s} Donnees contenus dans le fichier de configuration";
