...
class wsclient extends Core\wsclient {
	...
	public function &_initialise(
		...
		$this->setObjetveeamoneDatas ( $liste_class ["datas"] )
	...
	public function prepare_connexion(
		...
		$liste_data_veeamone = $this->getObjetveeamoneDatas ()
	...
	final public function userLogout(
			$params = array ()) {
		$this->onDebug ( __METHOD__, 1 );
		$this->postMethod ( 'revoke' . $this->getSession (), array () );
		return $this;
	}
	 ...
	 * @return datas
	 */
	public function &getObjetveeamoneDatas() {
		return $this->datas;
	}
	 ...
	 * @codeCoverageIgnore
	 */
	public function &setObjetveeamoneDatas(
			&$datas) {
		$this->datas = $datas;
		return $this;
	}
