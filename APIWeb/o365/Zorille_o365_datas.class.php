...
class datas extends Core\serveur_datas {
	...
	public function retrouve_param() {
		...
		$donnee_o365 = $this->_valideOption ( array (
				"o365_machines",
				"serveur"
		) );
		
		return $this->setServeurData ( $donnee_o365 );
	}
	
	/**
	 * Valide la presence de la definition d'un o365 nomme : $nom
	 *
	 * @param string $nom
	...
	static public function help() {
		...
		$help [__CLASS__] ["text"] [] .= "\t--o365_machines_serveur {Donnees du/des serveur/s} Donnees contenus dans le fichier de configuration";
