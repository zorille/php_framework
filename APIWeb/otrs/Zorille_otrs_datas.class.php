...
class datas extends Core\serveur_datas {
	...
	public function retrouve_param(): static {
		...
		$donnee_otrs = $this->_valideOption ( array (
				"otrs",
				"machines",
				"serveur" 
		) );
		
		return $this->setServeurData ( $donnee_otrs );
	}

	/**
	 * Valide la presence de la definition d'un otrs nomme : $nom
	 *
	 * @param string $nom
	...
	static public function help(): array|string {
		...
		$help [__CLASS__] ["text"] [] .= "otrs Datas :";
		$help [__CLASS__] ["text"] [] .= "\t--otrs_machines_serveur {Donnees du/des serveur/s} Donnees contenus dans le fichier de configuration";
