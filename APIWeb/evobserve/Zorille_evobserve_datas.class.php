...
class datas extends Core\serveur_datas {
	...
	public function retrouve_param(): static {
		...
		$donnee_evobserve = $this->_valideOption ( array (
				"evobserve",
				"machines",
				"serveur" 
		) );
		
		return $this->setServeurData ( $donnee_evobserve );
	}

	/**
	 * Valide la presence de la definition d'un evobserve nomme : $nom
	 *
	 * @param string $nom
	...
	static public function help(): array|string {
		...
		$help [__CLASS__] ["text"] [] .= "evobserve Datas :";
		$help [__CLASS__] ["text"] [] .= "\t--evobserve_machines_serveur {Donnees du/des serveur/s} Donnees contenus dans le fichier de configuration";
