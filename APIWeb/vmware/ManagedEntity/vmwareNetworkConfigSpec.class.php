...
/**
 * class vmwareNetworkConfigSpec<br>
 ...
 * @subpackage VMWare
 */
class vmwareNetworkConfigSpec extends vmwareManagedEntity {

	/*********************** Creation de l'objet *********************/
	/**
	 * Instancie un objet de type vmwareNetworkConfigSpec.
	 * @codeCoverageIgnore
	 ...
	 */
	static function &creer_vmwareNetworkConfigSpec(&$liste_option, &$ObjectVmwareWsclient, $sort_en_erreur = false, $entete = __CLASS__) {
		abstract_log::onDebug_standard ( __METHOD__, 1 );
		$objet = new vmwareNetworkConfigSpec ( $sort_en_erreur, $entete );
