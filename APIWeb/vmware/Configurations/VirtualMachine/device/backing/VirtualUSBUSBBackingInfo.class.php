...
/**
 * class VirtualUSBUSBBackingInfo<br>
 ...
 * @subpackage VMWare
 */
class VirtualUSBUSBBackingInfo extends VirtualDeviceDeviceBackingInfo {

	/*********************** Creation de l'objet *********************/
	/**
	 * Instancie un objet de type VirtualUSBUSBBackingInfo.
	 * @codeCoverageIgnore
	 ...
	 */
	static function &creer_VirtualUSBUSBBackingInfo(&$liste_option, $sort_en_erreur = false, $entete = __CLASS__) {
		abstract_log::onDebug_standard ( __METHOD__, 1 );
		$objet = new VirtualUSBUSBBackingInfo ( $sort_en_erreur, $entete );
	...
	public function &renvoi_objet_soap($arrayObject = false) {
		$soap_var = new soapvar ( $this->renvoi_donnees_soap ( $arrayObject ), SOAP_ENC_OBJECT, "VirtualUSBUSBBackingInfo" );
		return $soap_var;
	}
