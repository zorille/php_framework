...
/**
 * class VirtualCdromIsoBackingInfo<br>
 * @package Lib
 * @subpackage VMWare
 */
class VirtualCdromIsoBackingInfo extends VirtualDeviceFileBackingInfo {
	...
	/*********************** Creation de l'objet *********************/
	/**
	 * Instancie un objet de type VirtualCdromIsoBackingInfo.
	 * @codeCoverageIgnore
	 ...
	 */
	static function &creer_VirtualCdromIsoBackingInfo(&$liste_option, $sort_en_erreur = false, $entete = __CLASS__) {
		
		$objet = new VirtualCdromIsoBackingInfo ( $sort_en_erreur, $entete );
	...
	public function &renvoi_objet_soap($arrayObject = false) {
		$soap_var = new soapvar ( $this->renvoi_donnees_soap ( $arrayObject ), SOAP_ENC_OBJECT, "VirtualCdromIsoBackingInfo" );
		return $soap_var;
	}
