...
class datas extends Core\serveur_datas {
	...
	public function retrouve_param() {
		...
		$donnee_pipedrive = $this->_valideOption ( array (
				"pipedrive",
				"machines",
				"serveur" 
		) );
		
		return $this->setServeurData ( $donnee_pipedrive );
	}

	/**
	 * Valide la presence de la definition d'un pipedrive nomme : $nom
	 *
	 * @param string $nom        	
	...
	static public function help() {
		...
		$help [__CLASS__] ["text"] [] .= "pipedrive Datas :";
		$help [__CLASS__] ["text"] [] .= "\t--pipedrive_machines_serveur {Donnees du/des serveur/s} Donnees contenus dans le fichier de configuration";
