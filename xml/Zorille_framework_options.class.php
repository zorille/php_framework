...
class options extends xml {
	 ...
	 */
	/**
	 * Creer l'objet et prepare la valeur du sort_en_erreur. Les options doivent etre du type --option et/ou --option=var
	 *
	 * @param bool $sort_en_erreur Prend les valeurs true/false.
	...
	/**
	 * Retrouve les parametres conf/conf_regexp/conf_dir dans la ligne de commande ou --conf=/--conf_regexp=/--conf_dir= et leurs parametres dans la ligne de commande
	 *
	 * @param string $option
	 ...
	 */
	/**
	 * Prend un parametre au format class@[using='oui']<br> et renvoi un tableau au format :<br> $tableau['class']=class<br> $tableau['param']=using<br> $tableau['result']=oui<br>
	 *
	...
	public function _valideOption(
		...
		$datas = $this->renvoi_variables_standard ( $chemin_option, $valeur_par_defaut );
