 ...
 */
/**
 * class splunk_datamodel_model_name
 *
 * @package Lib
 * @subpackage splunk
 */
class splunk_datamodel_model_name extends splunk_datamodel_model {
	/**
	 * var privee
	 *
	 * @access private
	 ...
	 */
	/**
	 * Instancie un objet de type splunk_datamodel_model_name. @codeCoverageIgnore
	 ...
	 * @return splunk_datamodel_model_name
	 */
	static function &creer_splunk_datamodel_model_name(&$liste_option, &$splunk_webservice_rest, $model_name, $sort_en_erreur = false, $entete = __CLASS__) {
		abstract_log::onDebug_standard ( __METHOD__, 1 );
		$objet = new splunk_datamodel_model_name ( $sort_en_erreur, $entete );
	...
	/**
	 * Resource: datamodel/model/{model_name}
	 *   Method: Get 
	...
	static public function help() {
		...
		$help [__CLASS__] ["text"] [] .= "splunk_datamodel_model_name :";
