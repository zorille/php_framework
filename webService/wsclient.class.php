...
class wsclient extends abstract_log {
	 ...
	 * @return wsclient
	 */
	static function &creer_wsclient(&$liste_option, $sort_en_erreur = false, $entete = __CLASS__) {
	 ...
	 */
	public function retrouve_variables_tableau($serveur_data) {
	 ...
	 * @throws Exception
	 */
	public function envoi_requete($header = '') {
		$this ->onDebug ( __METHOD__, 1 );
	...
	/**
	 * Ajoute un hearder HTTP. Par defaut : Content-Type: application/json
	 * Necessite un connexion curl active
	 * @param string $header
	 * @return wsclient
	 */
	public function gere_header($header = '') {
	...
	/**
	 * Gere le type de request (GET, POST, PUt ou DELETE)
	 * En cas de request differente de GET : ajoute les donnees en mode POSTDATA
	 * Necessite un connexion curl active
	 * @return wsclient
	 */
	...
	/**
	 * Ajoute les donnees en mode POSTDATA si la request est de type POST
	 * Necessite un connexion curl active
	 * @return wsclient
	 */
	...
	/**
	 * Ajoute l'utilisateur et son mon de passe dans le header HTTP
	 * Necessite un connexion curl active
	 * @return wsclient
	 */
	...
	/**
	 * Ajoute les donnees du proxy, s'il existe
	 * Necessite un connexion curl active
	 * @return wsclient
	 */
	...
	/**
	 * Construit une url standard a partir du getHost et getUrl.<br/>
	 * Choisi entre la methode GET ou POST
	 ...
	 * @codeCoverageIgnore
	 */
	public function &setNoconnexion($no_connexion) {
	 ...
	 * @codeCoverageIgnore
	 */
	public function &setParams($param, $value = "", $add = false) {
		if ($add) {
	 ...
	 * @codeCoverageIgnore
	 */
	public function &setPostDatas($post_datas) {
	 ...
	 * @codeCoverageIgnore
	 */
	public function &setConnexionTimeout($connection_timeout) {
	 ...
	 * @codeCoverageIgnore
	 */
	public function &setValidSSL($validSSLcert) {
	 ...
	 * @codeCoverageIgnore
	 */
	public function &setGestionConnexionUrl(&$gestion_connexion_url) {
	 ...
	 * @codeCoverageIgnore
	 */
	public function &setObjetCurl(&$curl) {
