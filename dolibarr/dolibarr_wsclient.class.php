...
class dolibarr_wsclient extends wsclient {
	 ...
	 */
	static function &creer_dolibarr_wsclient(&$liste_option, &$dolibarr_datas, $sort_en_erreur = false, $entete = __CLASS__) {
	 ...
	 * @codeCoverageIgnore
	 */
	public function &setObjetdolibarrDatas(&$dolibarr_datas) {
