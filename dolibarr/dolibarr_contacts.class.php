...
class dolibarr_contacts extends dolibarr_ci {
	 ...
	 */
	static function &creer_dolibarr_contacts(&$liste_option, &$dolibarr_webservice_rest, $sort_en_erreur = false, $entete = __CLASS__) {
	 ...
	 * params : sortfield,sortorder,limit,page,thirdparty_ids,sqlfilters
	 * @codeCoverageIgnore
	 ...
	 * @throws  Exception
	 */
	public function runSingleContact($search, $params = array()) {
		$this ->onDebug ( __METHOD__, 1 );
