...
class desc_bd_gestion_zabbix extends gestion_definition_table {
	 ...
	 */
	static function &creer_desc_bd_gestion_zabbix(options &$liste_option, bool|string $sort_en_erreur = false, string $entete = __CLASS__): desc_bd_gestion_zabbix
	{
	...
	private function _chargeChampsCi(): bool
	{
