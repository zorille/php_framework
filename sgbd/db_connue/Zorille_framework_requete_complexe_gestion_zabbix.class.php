...
class requete_complexe_gestion_zabbix extends desc_bd_gestion_zabbix {
	/*********************** Creation de l'objet *********************/
	/**
	 * Instancie un objet de type requete_complexe_gestion_zabbix.
	 * @codeCoverageIgnore
	 * @param options $liste_option Reference sur un objet options
	 * @param string|Boolean $sort_en_erreur Prend les valeurs oui/non ou true/false
	 * @param string $entete Entete des logs de l'objet
	 * @return requete_complexe_gestion_zabbix
	 */
	static function &creer_requete_complexe_gestion_zabbix(&$liste_option, $sort_en_erreur = false, $entete = __CLASS__) {
		$objet = new requete_complexe_gestion_zabbix ( $sort_en_erreur, $entete );
