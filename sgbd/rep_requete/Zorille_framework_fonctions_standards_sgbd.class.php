...
class fonctions_standards_sgbd extends abstract_log {
	...
	static public function verifie_variable_sgbd(
		...
		if (isset ( $liste_donnees_db [$nom_base . "utilisateur"] ) && $liste_donnees_db [$nom_base . "utilisateur"] != "") {
			$CODE_RETOUR ["utilisateur"] = $liste_donnees_db [$nom_base . "utilisateur"];
		} else {
	...
	/**
	 * Parse les options passees en ligne de commande ou par xml et creer un objet db.<br> Include : $INCLUDE_FONCTIONS<br> Arguments reconnus :<br> Pour une base :<br> --sql=oui <br> --dbhost=xx <br> --username=xx <br> --password=xx <br> --database=xx <br> --SQL_type=mysql <br> --SQL_sort_en_erreur=oui<br> Pour les multi-bases :<br> --sql=multi <br> --noms_sgbd=\"NOM_BD1 NOM_BD2 ...\"<br> --NOM_BD1_dbhost=xx <br> --NOM_BD1_username=xx <br> --NOM_BD1_password=xx <br> --NOM_BD1_database=xx <br> --NOM_BD1_SQL_type=mysql //par defaut mysql<br> --NOM_BD1_SQL_sort_en_erreur=oui //par defaut oui<br> --NOM_BD1_using=oui/non //par defaut oui<br> --NOM_BD2_dbhost=xx <br> .<br> .<br> .
	 *
	 * @param options &$liste_option Pointeur sur les arguments
